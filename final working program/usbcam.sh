...
mjpg_streamer -i "input_uvc.so -d /dev/video4 -f 10 -n" -o "output_http.so -w /usr/src/mjpg-streamer-experimental/www -p 9000" &
mjpg_streamer -i "input_uvc.so -d /dev/video6 -f 10 -n" -o "output_http.so -w /usr/src/mjpg-streamer-experimental/www -p 9010" &
